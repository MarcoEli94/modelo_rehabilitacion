...
DETECTED_ERROR_MAP = {
    ...
    "descenso_de_codo_o_muneca": "descenso del codo o de la muñeca durante el movimiento",
    "elevacion_compensatoria_hombro": "elevación compensatoria del hombro",
    "rango_de_movimiento_insuficiente": "rango de movimiento insuficiente",
    "asimetria_en_el_movimiento": "asimetría en el movimiento",
